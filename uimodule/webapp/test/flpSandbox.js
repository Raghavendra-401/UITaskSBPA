		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Task UI BPA",
									"targetURL": "#uitaskbpauimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uitaskbpauimodule-display": {
								"semanticObject": "uitaskbpauimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.task.bpa.uimodule",
									"url": sap.ui.require.toUrl("ui/task/bpa/uimodule")
								}
							}
						}
					}
